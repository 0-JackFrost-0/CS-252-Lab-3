...
carnatic_notes = {
    "Sa": sa_frequency,
    "Ri1": sa_frequency * 256 / 243,
    "Ri2": sa_frequency * 9 / 8,
    "Ga1": sa_frequency * 32 / 27,
    "Ga2": sa_frequency * 81 / 64,
    "Ma1": sa_frequency * 4 / 3,
    "Ma2": sa_frequency * 729 / 512,
    "Pa": sa_frequency * 3 / 2,
    "Dha1": sa_frequency * 128 / 81,
    "Dha2": sa_frequency * 27 / 16,
    "Ni1": sa_frequency * 16 / 9,
    "Ni2": sa_frequency * 243 / 128,
    "SaU": sa_frequency * 2,
}
...
while True:
    ...
    if Job == "TRANSMIT":
        ...
        while not Done:
            ...
            elif (frequency > carnatic_notes["Ri1"] - 5) and (
                carnatic_notes["Ri1"] + 5 > frequency
            ):
                print("Re1")
                received_data.append("001")
            elif (frequency > carnatic_notes["Ga2"] - 5) and (
                carnatic_notes["Ga2"] + 5 > frequency
            ):
                print("Ga2")
            ...
            elif (frequency > carnatic_notes["Ni2"] - 5) and (
                carnatic_notes["Ni2"] + 5 > frequency
            ):
                print("Ni2")
